...
class Steering:
    def __init__(self, dataset_name, model_arg, tokenizer_arg, data_dir, custom_args, 
        ...
        for mode in ['train', 'test']:
            ...
            elif dataset_name == 'refusal_data_full_answers_jinja_augmented_v2':
                data = get_refusal_pairs(data_dir, mode=mode, 
                             path=f"{data_dir}/refusal_data_full_answers_jinja_augmented.json", augment_bad_answer=True, augment_good_answer=True)
